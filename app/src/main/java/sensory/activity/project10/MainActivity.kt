...
import sensory.activity.project10.ui.theme.Project10Theme
...
import sensory.activity.project10.GestureActivity
import sensory.activity.project10.HumiditySensor
import sensory.activity.project10.SensorsViewModel
import sensory.activity.project10.TemperatureSensor
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sensorsViewModel.initializeSensors(TemperatureSensor(applicationContext),
            HumiditySensor(applicationContext)
        )
